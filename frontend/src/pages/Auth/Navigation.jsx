        ...
        >
            <div className='flex flex-col justify-center space-y-4'>
                ...
                >
                    ...
                    <span
                        className="hidden nav-item-name mt-[3rem]">SHOP</span> {""}
                </Link>
                <Link to='/cart'
            ...
            <div className='relative'>
                    ...
                    <ul className={`absolute right-0 mt-2 mr-14 space-y-2 bg-white text-gray-600 ${!userInfo.isAdmin ? "-top-20" : "-top-80"}`} >
                        {userInfo.isAdmin && (
                            <>
                                ...
                                <li ><Link to="/admin/categorylist"
                                    className='block px-4 py-2 hover:bg-gray-100'>Category</Link>
                                </li>
                                <li>
                                    <Link to="/admin/oderlist"
                ...
                {!userInfo && (
                    <ul>
                        ...
                        <li>
                            <Link to="/register"
                                className='flex items-center mt-5 transition-transform transform hover:translate-x-2'></Link>
